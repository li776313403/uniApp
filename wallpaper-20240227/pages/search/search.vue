<template>
	<view class="searchLayout">
		...
		<view v-else>
			<view class="list">
				<navigator :url="`/pages/preview/preview?classId=${item.classid}&wallId=${item._id}`" class="item" v-for="item in classList" :key="item._id">
...
import { DetailWallI, SearchWallSearchI } from '../../interface/wallpaper';
// ///////////////////////////////////////////////////refs///////////////////////////////////////////////////
/** 查询参数 */
const queryParams = ref<SearchWallSearchI>({
	pageNum: 1,
	pageSize: 12,
	keyword: ''
});
/** 搜索历史词 */
const historySearch = ref<Array<string>>(uni.getStorageSync('historySearch') || []);
/** 热门搜索词 */
...
/** 搜索结果列表 */
const classList = ref<Array<DetailWallI>>([]);
// ///////////////////////////////////////////////////func///////////////////////////////////////////////////
/** 搜索结果获取 */
const searchData = async () => {
	try {
		let res = await api.searchWall(queryParams.value);
